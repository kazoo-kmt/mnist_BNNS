...
//  BnnsBuilder.swift
//
//  Created by Pavel Ivashkov, paiv on 2016-09-18. Modified by Kazu Komoto on 2016-12-10
//
//  MIT License
...
//    func connect(weights: [Float32], bias: [Float32]) -> Self {
    func connect(weights: UnsafePointer<Float32>, bias: UnsafePointer<Float32>) -> Self {
